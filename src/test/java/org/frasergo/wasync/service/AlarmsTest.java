...
public class AlarmsTest {
    ...
    private Intent verifyAlarmScheduled(long scheduled, String expectedType) {
        ...
        assertThat(component.getPackageName()).isEqualTo("org.frasergo.wasync");
        assertThat(component.getClassName()).isEqualTo("org.frasergo.wasync.service.SmsBackupService");
