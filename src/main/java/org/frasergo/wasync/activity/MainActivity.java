...
package org.frasergo.wasync.activity;
...
import org.frasergo.wasync.BuildConfig;
import org.frasergo.wasync.Consts;
import org.frasergo.wasync.R;
import org.frasergo.wasync.activity.auth.AccountManagerAuthActivity;
import org.frasergo.wasync.activity.auth.OAuth2WebAuthActivity;
import org.frasergo.wasync.activity.donation.DonationActivity;
import org.frasergo.wasync.auth.OAuth2Client;
import org.frasergo.wasync.calendar.CalendarAccessor;
...
import org.frasergo.wasync.preferences.AuthMode;
import org.frasergo.wasync.preferences.AuthPreferences;
import org.frasergo.wasync.preferences.BackupManagerWrapper;
import org.frasergo.wasync.preferences.Preferences;
import org.frasergo.wasync.receiver.SmsBroadcastReceiver;
import org.frasergo.wasync.service.Alarms;
import org.frasergo.wasync.service.BackupType;
import org.frasergo.wasync.service.SmsBackupService;
import org.frasergo.wasync.service.SmsRestoreService;
import org.frasergo.wasync.service.state.RestoreState;
import org.frasergo.wasync.tasks.OAuth2CallbackTask;
import org.frasergo.wasync.utils.AppLog;
import org.frasergo.wasync.utils.ListPreferenceHelper;
...
import static org.frasergo.wasync.preferences.Preferences.Keys.CONNECTED;
import static org.frasergo.wasync.preferences.Preferences.Keys.DONATE;
import static org.frasergo.wasync.preferences.Preferences.Keys.ENABLE_AUTO_BACKUP;
import static org.frasergo.wasync.preferences.Preferences.Keys.IMAP_SETTINGS;
